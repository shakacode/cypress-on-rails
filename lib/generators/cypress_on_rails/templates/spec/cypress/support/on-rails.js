// CypressOnRails: core commands, DO NOT remove
...
// TODO: maybe instead of `app` this should be called `rails`?
Cypress.Commands.add('app', function (name, command_options) {
  cy.appCommands({name: name, options: command_options})
})
// END CypressOnRails core-commands

// TODO: app prefix is a little weird here
...
// Optional: automatically clean database data before every test
// beforeEach(() => {
